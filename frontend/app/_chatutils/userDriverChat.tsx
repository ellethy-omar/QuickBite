...
export default function UserDriverChat() {
  ...
  const [chatData, setChatData] = useState<ChatDriver>(chat ? JSON.parse(chat as string) : { id: '1', messages: [], receiverId: '', senderId: '', orderId: '' });
  ...
  const ws = useChatWebSocket({ 
    ...
    setChatData, 
    lastMessageRef, 
    role: (role as 'user' | 'driver') || 'driver' 
  });
